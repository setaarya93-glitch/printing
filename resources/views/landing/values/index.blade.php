    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
            <div class="text-center lg:text-left">
                <h2 class="text-4xl md:text-5xl font-black uppercase tracking-tighter leading-tight mb-8 text-white">
                ...
                <p class="text-white text-base md:text-lg mb-10 md:mb-12 font-medium max-w-xl mx-auto lg:mx-0">
                    ...
                    @foreach($values as $value)
                        <div class="flex items-start text-left space-x-4 p-4 rounded-2xl hover:bg-white/5 transition-colors group">
                            <div class="mt-1 flex-shrink-0">
                                <div class="w-6 h-6 rounded-full border-2 border-white flex items-center justify-center group-hover:bg-white transition-colors">
                                    <svg class="w-3 h-3 text-white group-hover:text-dark-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                                </div>
                            </div>
                            <div>
                                <h4 class="text-base md:text-lg font-bold uppercase tracking-tight text-white">{{ $value['title'] }}</h4>
                                <p class="text-white text-sm md:text-base mt-1">{{ $value['desc'] }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="relative mt-8 lg:mt-0">
                ...
                {{-- Fast Badge --}}
                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 md:p-8 rounded-full border-4 md:border-[10px] border-dark-blue shadow-2xl animate-spin-slow">
