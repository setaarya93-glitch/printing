<section class="py-20 md:py-24 bg-fast-dark text-white overflow-hidden relative">
    {{-- Background Glow --}}
    <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] md:w-[800px] h-[400px] md:h-[800px] bg-fast-blue/10 rounded-full blur-[80px] md:blur-[120px]"></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="grid lg:grid-cols-2 gap-12 md:gap-20 items-center">
                    ...
                    @foreach($values as $value)
                        <div class="flex items-start text-left space-x-4 p-4 rounded-2xl hover:bg-white/5 transition-colors group">
                            <div class="mt-1 flex-shrink-0">
                                <div class="w-6 h-6 rounded-full border-2 border-fast-green flex items-center justify-center group-hover:bg-fast-green transition-colors">
                                    <svg class="w-3 h-3 text-fast-green group-hover:text-fast-dark" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M5 13l4 4L19 7"/></svg>
                                </div>
                            </div>
                            <div>
            ...
            <div class="relative mt-8 lg:mt-0">
                ...
                {{-- Fast Badge --}}
                <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-fast-blue p-5 md:p-8 rounded-full border-4 md:border-[10px] border-fast-dark shadow-2xl animate-spin-slow">
