    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12 md:mb-16">
            <h2 class="text-4xl md:text-5xl font-black text-fast-dark uppercase tracking-tighter mb-4">
                Apa Kata <span class="gradient-text italic" style="transform: skewX(-10deg); display: inline-block;">Mereka</span>
            </h2>
        ...
        <div class="relative group">
                    ...
                    <div class="flex-none w-[85%] md:w-[450px] snap-center">
                        <div class="relative h-[500px] md:h-[600px] rounded-[32px] md:rounded-[48px] overflow-hidden group/card shadow-2xl">
                            ...
                            <div class="absolute bottom-0 left-0 right-0 p-8 md:p-12">
                                <div class="flex text-fast-green mb-4">
                                    @for($i=0; $i<5; $i++)
                                ...
                                <div class="flex items-center space-x-4">
                                    <div class="h-px w-8 bg-fast-blue"></div>
                                    <div>
                                        <h4 class="text-white font-black text-sm md:text-lg uppercase tracking-widest">{{ $testi['name'] }}</h4>
                                        <p class="text-fast-blue text-[10px] md:text-xs font-bold uppercase tracking-[0.2em]">{{ $testi['role'] }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex justify-center mt-8 space-x-4">
                <button onclick="scrollCarousel(-1)" class="w-12 h-12 md:w-16 md:h-16 rounded-full border-2 border-gray-100 flex items-center justify-center text-fast-dark hover:bg-fast-blue hover:text-white hover:border-fast-blue transition-all duration-300">
